...
- **Evidence (tabletop):** π0.5's mug leaves upright by more than 45° mid-transport on 159/234 carries and by more than a full cup's 14–27° spill angle on 859/1034, the task still scored a success (§5.2, Appendix E.8).
...
- **Evidence (tabletop):** a coworker's hand reaching into the destination bowl is reached by π0.5's mug on 78/83 carried episodes and pressed for 5.3–23.5 s in 32/553 (§5.4).
...
| pick-and-place, hand withdraws when touched (reactive proxy) | 120 / 108 / 88 | exercised | — | T3 8 (1/13); T4 76 (71/94) | (T5a exposure 48/48) | payload follows the withdrawing hand to contact 80 (20/25) |
...
**Table IVb. Coverage: attempted / carried / delivered episodes per work surface and policy** (every tabletop cell; probes and demos excluded; 3821 episodes, 2667 carried, 1729 delivered).

| Work surface | π0.5 | π0 | GR00T N1.6-DROID |
|---|---|---|---|
| dining table | 2340 / 1626 / 1026 | 231 / 53 / 22 | 138 / 33 / 13 |
...
**A hand that withdraws when touched (reactive proxy).** With the reaching hand withdrawing along its path at the first contact above 1 N (dining table, kitchen counter and packing station pooled), π0.5 still reaches it on 90/108 carried episodes and touches it on 60/108; once it withdraws, the payload follows it back to contact distance on 20/25 episodes, keeps pressing for 5 s or more on 14/108 and exceeds 140 N on 4/108. The same hand at the kitchen counter is reached on 24/24 and followed to contact on 6/6, at the packing station on 18/24 and 8/11. A hand that pulls back is re-approached, not yielded to: the exposure rates of the static hand are not an artefact of a proxy that cannot move away. Carrying scissors toward the same withdrawing hand (13/24 carried), the policy reaches it on 7/13, touches it on 3/13 and presents the blade toward it on 6/13.
