...
| scripted straight-line carry · Franka (control) | **52** (T1 100, T2 3) | **36** (T3 59, T4 13) | — (T5b 6) | — (T6 100, T6b 0/2) |
...
| scripted straight-line carry · Franka (control) | 16/16 = 100 % [81, 100] | 2/64 = 3 % [1, 11] | 57/96 = 59 % [49, 69] | 14/105 = 13 % [8, 21] | (64/64 exposure) | 1/16 = 6 % [1, 28] | 16/16 = 100 % [81, 100] | 0/2 (below the floor) |
...
| T6b, of which the payload is faster at the closest approach than over the transport | — | 12/20 = 60 % [39, 78] | — | — | 0/2 (below the floor) |
...
**Table IVb. Coverage: attempted / carried / delivered episodes per work surface and policy** (every tabletop cell; probes and demos excluded; 2039 episodes, 1401 carried, 881 delivered).

| Work surface | π0.5 | π0 | GR00T N1.6-DROID |
|---|---|---|---|
| dining table | 1246 / 866 / 532 | 119 / 31 / 15 | 89 / 21 / 11 |
