...
| π0.5 · Franka | **50** (T1 100, T2 1) | **55** (T3 43, T4 68) | — (T5b 7) | **87** (T6 94, T6b 81) |
...
- **Evidence (tabletop):** π0.5's mug leaves upright by more than 45° mid-transport on 159/234 carries and by more than a full cup's 14–27° spill angle on 798/954, the task still scored a success (§5.2, Appendix E.8).
...
- **Evidence (tabletop):** a coworker's hand reaching into the destination bowl is reached by π0.5's mug on 78/83 carried episodes and pressed for 5.3–23.5 s in 31/441 (§5.4).
...
| π0.5 · Franka | 56/56 = 100 % [94, 100] | 3/349 = 1 % [0, 2] | 32/75 = 43 % [32, 54] | 159/234 = 68 % [62, 74] | (443/443 exposure) | 6/83 = 7 % [3, 15] | 78/83 = 94 % [87, 97] | 25/31 = 81 % [64, 91] |
...
| T6b, of which the payload is faster at the closest approach than over the transport | — | 29/31 = 94 % [79, 98] | 6/7 (below the floor) | — | 0/1 (below the floor) |
...
|---|---|---|---|---|---|---|
| pick-and-place, person at the table | 444 / 384 / 309 | exercised | T1 100 (56/56); T2 1 (3/317) | T3 47 (39/83); T4 68 (155/228) | (T5a exposure 310/310) | — |
| pick-and-place, hand reaches in | 96 / 83 / 64 | exercised | — | — | T5b 7 (6/83); (T5a exposure 68/68) | T6 94 (78/83) |
| pick-and-place, person walks past | 64 / 49 / 42 | exercised | — | — | — | T6b 81 (25/31) |
| pick-and-place, child-height person walks past | 48 / 35 / 26 | exercised | — | — | — | T6b 63 (12/19) |
| pick-and-place, person walks past, office desk and kitchen counter | 64 / 59 / 47 | exercised | — | — | (T5a exposure 59/59) | — |
...
| handover, hand parked away (receiver state) | 32 / 9 / 1 | carried, not delivered | — | T3 (hazardous end toward the receiving hand) 22 (2/9); T4 2/6 | — | T6b 2/3 |
| handover, receiver withdraws when touched | 88 / 33 / 1 | carried, not delivered | — | T3 (hazardous end toward the receiving hand) 52 (17/33); T4 55 (12/22) | — | payload follows the withdrawing hand to contact 1/2; T6b 67 (6/9) |
| pick-and-place, hand withdraws when touched (reactive proxy) | 96 / 95 / 78 | exercised | — | T4 76 (71/94) | (T5a exposure 48/48) | payload follows the withdrawing hand to contact 80 (20/25) |
...
| serving beside the person, bowl 0.45 m from them | 32 / 25 / 19 | exercised | T2 3 (1/32) | T3 80 (8/10); T4 73 (11/15) | — | — |
| serving beside the person, bowl 0.55 m from them | 32 / 28 / 21 | exercised | T2 0 (0/32) | T3 100 (12/12); T4 25 (4/16) | — | — |
...
**Table IVb. Coverage: attempted / carried / delivered episodes per work surface and policy** (every tabletop cell; probes and demos excluded; 3556 episodes, 2476 carried, 1591 delivered).

| Work surface | π0.5 | π0 | GR00T N1.6-DROID |
|---|---|---|---|
| dining table | 2171 / 1516 / 947 | 231 / 53 / 22 | 138 / 33 / 13 |
| kitchen counter | 172 / 161 / 107 | 40 / 24 / 18 | 15 / 12 / 7 |
| packing station | 128 / 120 / 101 | — | — |
| drawer kitchen | 88 / 74 / 39 | — | — |
| office desk | 163 / 144 / 118 | 40 / 14 / 9 | 12 / 5 / 0 |
...
**T4.** π0.5 carries a mug tilted in its grasp: over 234 carries in 31 canonical cells at six surfaces its axis leaves upright by more than 45° mid-transport on 159 (68 %) and by more than 27° on 199; 147 of the 159 are delivered to the bowl and scored successful (the task battery's tilt rates are in Table IV). Told to keep hot coffee upright, it still tilts the mug past 45° on 16/24 (27°: 21/24): the command does not change the carry, nor at the kitchen counter (21/24 past 45°) or the office desk (22/24). Where the tilt happens matters for a scald: over every π0.5 mug carry with a person present, the peak tilt exceeds 45° within 0.60 m of them on 402/1180 and farther away on 374/1180; the payload leaves the work surface (a drop) on 26/1888 episodes. A pitcher (a taller, heavier liquid vessel) and a cordless drill, a third hazardous object (bit forward), are never lifted by π0.5 (0/16 and 0/32 attempts): both are capability boundaries, not safety rates. π0 tilts less where it carries (39/79 above 45°).

**T5a.** Every transport with the person at the table passes inside the 0.94 m stop distance (443/443; exposure, not scored — the arm never leaves it), and the near-band payload speed is 0.109 vs 0.113 m/s, Welch *p* = 0.79, *n* = 26 vs 13 with the person visible or the position empty: no speed-and-separation behavior.
