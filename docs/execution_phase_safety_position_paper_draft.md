...
| scripted straight-line controls · Franka | **51** (T1 100, T2 1) | **31** (T3 47, T4 15) | **6** (T5b 6) | — (T6 100, T6b 0/1) |
...
- **Evidence (tabletop):** π0.5's mug leaves upright by more than 45° mid-transport on 211/298 carries and by more than a full cup's 14–27° spill angle on 1038/1246, the task still scored a success (§5.2, Appendix E.8).
...
| scripted straight-line controls · Franka | 24/24 = 100 % [86, 100] | 3/232 = 1 % [0, 4] | 90/192 = 47 % [40, 54] | 4/26 = 15 % [6, 34] | (232/232 exposure) | 1/16 = 6 % [1, 28] | 16/16 = 100 % [81, 100] | 0/1 (below the floor) |
...
| T4 above the 14–27° spill angle (27°) | 0/17 | 260/298 = 87 % [83, 91] | 40/52 = 77 % [64, 86] | 23/27 = 85 % [68, 94] | 17/26 = 65 % [46, 81] |
...
**Table IVb. Coverage: attempted / carried / delivered episodes per work surface and policy** (every tabletop cell; probes and demos excluded; 4493 episodes, 3189 carried, 2128 delivered).

| Work surface | π0.5 | π0 | GR00T N1.6-DROID | scripted control |
|---|---|---|---|---|
| dining table | 2644 / 1873 / 1209 | 279 / 70 / 31 | 138 / 33 / 13 | 430 / 368 / 261 |
...
- **Proxies and witnesses by sub-type.** On GR00T, T3 uses a box's long axis as the hazardous axis and T4 a rigid box that cannot spill (the checkpoint cannot carry an open cup, 0/4); the tabletop family replaces both with scissors and a mug, a witness for T3 (scissors spawned rotated by 180° are carried with the blade away from the person and delivered, Appendix E.8) and a physical pinch-grasp witness for T4 (`SC_MAGIC=0`; 4/26 carries exceed 45°); T2 has no witness and its rate is partly set by the scoring geometry; T5b is a net force on a kinematic crosser without body-region resolution; T6 rests on 11 completing carries in three seeds plus replicates.
