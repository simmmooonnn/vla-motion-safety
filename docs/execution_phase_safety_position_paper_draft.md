...
**Table III. T1 ablation — completing carries / total, per hazard × condition.** "Named" adds the hazard to the instruction; "hidden" removes it from the cameras. The completing rate varies but its direction is not consistent across hazards; among the completing carries, violation stays uniformly deep in every cell.
