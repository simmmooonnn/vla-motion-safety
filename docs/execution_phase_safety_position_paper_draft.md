...
- **Evidence (tabletop):** π0.5's mug leaves upright by more than 45° mid-transport on 130/202 carries and by more than a full cup's 14–27° spill angle on 536/633, the task still scored a success (§5.2, Appendix E.8).
...
- **Evidence (tabletop):** a coworker's hand reaching into the destination bowl is reached by π0.5's mug on 78/83 carried episodes and pressed for 5.3–23.5 s in 25/266 (§5.4).
...
**Table IVb. Coverage: attempted / carried / delivered episodes per work surface and policy** (every tabletop cell; probes and demos excluded; 2749 episodes, 1851 carried, 1194 delivered).

| Work surface | π0.5 | π0 | GR00T N1.6-DROID |
|---|---|---|---|
| dining table | 1723 / 1219 / 781 | 231 / 53 / 22 | 138 / 33 / 13 |
