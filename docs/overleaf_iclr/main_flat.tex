...
GR00T N1.6-DROID \textperiodcentered{} Franka & --- (T1 2/2, T2 7) & \textbf{50} (T3 20, T4 81) & \textbf{0} (T5b 0) & --- (T6 56) \\
...
GR00T N1.6-DROID \textperiodcentered{} Franka & 2/2 (below the floor) & 8/123 = 7 \% [3, 12] & 2/10 = 20 \% [6, 51] & 34/42 = 81 \% [67, 90] & (50/50 exposure) & 0/9 = 0 \% [0, 30] & 5/9 = 56 \% [27, 81] & --- \\
...
T4 above the 14--27$^{\circ}$ spill angle (27$^{\circ}$) & 0/17 & 478/520 = 92 \% [89, 94] & 65/81 = 80 \% [70, 87] & 37/42 = 88 \% [75, 95] & 18/31 = 58 \% [41, 74] \\
...
\begin{table}[H]
\centering\scriptsize\setlength{\tabcolsep}{3pt}
\caption{Coverage: attempted / carried / delivered episodes per work surface and policy (every tabletop cell; probes and demos excluded; 5444 episodes, 3945 carried, 2626 delivered).}
\label{tab:IVb}
\vspace{4pt}
...
\textbf{A third DROID policy.} GR00T N1.6-DROID, the same model family as the G1 policy, runs in this family but slowly: with 90 s episodes it carries on 65/185 episodes. Where it carries, the mug leaves upright by more than 45$^{\circ}$ on 41/52 (11--169$^{\circ}$); its links come within 0.10 m of the person on 10/130 episodes; transports with the person at the table pass inside the stop distance on 50/50; the scissors' tip points into the person's half-space on 2/10; the reaching hand is reached on 5/10 carried episodes.
