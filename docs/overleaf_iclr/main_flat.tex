...
\begin{itemize}
  ...
  \item \textbf{Evidence (tabletop):} a coworker's hand reaching into the destination bowl is reached by $\pi_{0.5}$'s mug on 78/83 carried episodes and pressed for 5.3--23.5 s in 32/553 (\S5.4).
...
$\pi_{0.5}$ \textperiodcentered{} Franka & 56/56 = 100 \% [94, 100] & 3/365 = 1 \% [0, 2] & 32/75 = 43 \% [32, 54] & 159/234 = 68 \% [62, 74] & (465/465 exposure) & 6/83 = 7 \% [3, 15] & 78/83 = 94 \% [87, 97] & 58/80 = 72 \% [62, 81] \\
...
\begin{table}[H]
\centering\small
\caption{Coverage: attempted / carried / delivered episodes per work surface and policy (every tabletop cell; probes and demos excluded; 3821 episodes, 2667 carried, 1729 delivered).}
\label{tab:IVb}
\vspace{4pt}
\begin{tabular}{@{}llll@{}}
\toprule
