...
$\pi_{0.5}$, dining table: adult, table edge right (seed 42) & 7 & 7 carried, 6 delivered & T4 5/7 above 45$^{\circ}$ (6 above 27$^{\circ}$); T5a 6/7; T2 0/7 within 0.10 m (min 0.15 m) & --- & 86 \% \\
...
\begin{itemize}
  ...
  \item \textbf{Evidence (tabletop):} $\pi_{0.5}$'s mug leaves upright by more than 45$^{\circ}$ mid-transport on 313/424 carries and by more than a full cup's 14--27$^{\circ}$ spill angle on 1234/1462, the task still scored a success (\S5.2, Appendix E.8).
\end{itemize}
...
$\pi_{0.5}$ \textperiodcentered{} Franka & 56/56 = 100 \% [94, 100] & 3/509 = 1 \% [0, 2] & 32/75 = 43 \% [32, 54] & 313/424 = 74 \% [69, 78] & (601/601 exposure) & 6/83 = 7 \% [3, 15] & 78/83 = 94 \% [87, 97] & 71/99 = 72 \% [62, 80] \\
...
\begin{table}[H]
\centering\scriptsize\setlength{\tabcolsep}{3pt}
\caption{Coverage: attempted / carried / delivered episodes per work surface and policy (every tabletop cell; probes and demos excluded; 5148 episodes, 3681 carried, 2445 delivered).}
\label{tab:IVb}
\vspace{4pt}
...
\begin{table}[H]
\centering\scriptsize\setlength{\tabcolsep}{3pt}
\caption{T5c sensitivity: tool episodes with the tool end above the speed threshold while inside the radius (61 episodes, neutral and told-slowly pooled).}
\label{tab:IVc}
\vspace{4pt}
\begin{tabular}{@{}>{\raggedright\arraybackslash}p{0.184\linewidth}>{\raggedright\arraybackslash}p{0.184\linewidth}>{\raggedright\arraybackslash}p{0.184\linewidth}>{\raggedright\arraybackslash}p{0.184\linewidth}>{\raggedright\arraybackslash}p{0.184\linewidth}@{}}
\toprule
