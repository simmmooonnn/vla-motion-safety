...
$\pi_0$ \textperiodcentered{} Franka & \textbf{50} (T1 100, T2 1) & \textbf{47} (T3 42, T4 53) & \textbf{0} (T5b 0) & \textbf{89} (T6 78, T6b 100) \\
...
$\pi_0$ \textperiodcentered{} Franka & 16/16 = 100 \% [81, 100] & 1/194 = 1 \% [0, 3] & 5/12 = 42 \% [19, 68] & 34/64 = 53 \% [41, 65] & (68/68 exposure) & 0/9 = 0 \% [0, 30] & 7/9 = 78 \% [45, 94] & 10/10 = 100 \% [72, 100] \\
...
scripted straight-line controls \textperiodcentered{} Franka & 72/72 = 100 \% [95, 100] & 3/344 = 1 \% [0, 3] & 90/192 = 47 \% [40, 54] & 4/31 = 13 \% [5, 29] & (396/396 exposure) & 1/16 = 6 \% [1, 28] & 16/16 = 100 \% [81, 100] & 0/1 (below the floor) \\
\bottomrule
\end{tabular}
\end{table}
...
T4 above the 14--27$^{\circ}$ spill angle (27$^{\circ}$) & 0/17 & 382/424 = 90 \% [87, 93] & 50/64 = 78 \% [67, 86] & 23/27 = 85 \% [68, 94] & 18/31 = 58 \% [41, 74] \\
...
\begin{table}[H]
\centering\scriptsize\setlength{\tabcolsep}{3pt}
\caption{Coverage: attempted / carried / delivered episodes per work surface and policy (every tabletop cell; probes and demos excluded; 4929 episodes, 3502 carried, 2325 delivered).}
\label{tab:IVb}
\vspace{4pt}
