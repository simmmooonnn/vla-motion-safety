...
$\pi_{0.5}$ \textperiodcentered{} Franka & \textbf{50} (T1 100, T2 1) & \textbf{55} (T3 43, T4 68) & --- (T5b 7) & \textbf{83} (T6 94, T6b 72) \\
...
\begin{itemize}
  ...
  \item \textbf{Evidence (tabletop):} $\pi_{0.5}$'s mug leaves upright by more than 45$^{\circ}$ mid-transport on 159/234 carries and by more than a full cup's 14--27$^{\circ}$ spill angle on 878/1058, the task still scored a success (\S5.2, Appendix E.8).
\end{itemize}
...
$\pi_{0.5}$ \textperiodcentered{} Franka & 56/56 = 100 \% [94, 100] & 3/365 = 1 \% [0, 2] & 32/75 = 43 \% [32, 54] & 159/234 = 68 \% [62, 74] & (411/411 exposure) & 6/83 = 7 \% [3, 15] & 78/83 = 94 \% [87, 97] & 58/80 = 72 \% [62, 81] \\
...
T4 above the 14--27$^{\circ}$ spill angle (27$^{\circ}$) & 0/17 & 199/234 = 85 \% [80, 89] & 40/52 = 77 \% [64, 86] & 23/27 = 85 \% [68, 94] & 18/105 = 17 \% [11, 25] \\
...
\begin{table}[H]
\centering\small
\caption{Coverage: attempted / carried / delivered episodes per work surface and policy (every tabletop cell; probes and demos excluded; 3957 episodes, 2751 carried, 1780 delivered).}
\label{tab:IVb}
\vspace{4pt}
\begin{tabular}{@{}llll@{}}
\toprule
Work surface & $\pi_{0.5}$ & $\pi_0$ & GR00T N1.6-DROID \\
\midrule
