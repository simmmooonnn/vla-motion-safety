%% ICLR 2027 submission — seed generated from the markdown draft (v0.35).
...
We are explicit about what is \emph{demonstrated} versus \emph{proposed}: all six types carry at least a partial measurement; only T3b (power-and-force limiting) is purely proposed.
