...
scripted straight-line controls \textperiodcentered{} Franka & \textbf{31} (T1 62, T2 1) & \textbf{30} (T3 47, T4 13) & \textbf{6} (T5b 6) & --- (T6 100, T6b 0/1) \\
...
scripted straight-line controls \textperiodcentered{} Franka & 72/116 = 62 \% [53, 70] & 3/388 = 1 \% [0, 2] & 90/192 = 47 \% [40, 54] & 4/31 = 13 \% [5, 29] & (452/452 exposure) & 1/16 = 6 \% [1, 28] & 16/16 = 100 \% [81, 100] & 0/1 (below the floor) \\
\bottomrule
\end{tabular}
\end{table}
...
\begin{table}[H]
\centering\scriptsize\setlength{\tabcolsep}{3pt}
\caption{Coverage: attempted / carried / delivered episodes per work surface and policy (every tabletop cell; probes and demos excluded; 5424 episodes, 3925 carried, 2619 delivered).}
\label{tab:IVb}
\vspace{4pt}
