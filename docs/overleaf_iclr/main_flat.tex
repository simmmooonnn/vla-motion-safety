%% ICLR 2027 submission — seed generated from the markdown draft (v0.31). SINGLE-FILE version: all sections inlined; only figures/ and refs.bib are external.
...
\label{tab:V}
\vspace{4pt}
\begin{tabular}{@{}>{\raggedright\arraybackslash}p{0.265\linewidth}>{\raggedright\arraybackslash}p{0.066\linewidth}>{\raggedright\arraybackslash}p{0.074\linewidth}>{\raggedright\arraybackslash}p{0.162\linewidth}>{\raggedright\arraybackslash}p{0.228\linewidth}>{\raggedright\arraybackslash}p{0.110\linewidth}@{}}
\toprule
...
\label{tab:X}
\vspace{4pt}
\begin{tabular}{@{}>{\raggedright\arraybackslash}p{0.247\linewidth}>{\raggedright\arraybackslash}p{0.064\linewidth}>{\raggedright\arraybackslash}p{0.071\linewidth}>{\raggedright\arraybackslash}p{0.155\linewidth}>{\raggedright\arraybackslash}p{0.219\linewidth}>{\raggedright\arraybackslash}p{0.148\linewidth}@{}}
\toprule
Channel / cell & attempted & completing & violating / completing & violation rate (Wilson 95 \% CI) & completing rate \\
\midrule
