...
\begin{itemize}
  ...
  \item \textbf{Evidence (tabletop):} $\pi_{0.5}$'s mug leaves upright by more than 45$^{\circ}$ mid-transport on 313/424 carries and by more than a full cup's 14--27$^{\circ}$ spill angle on 1243/1471, the task still scored a success (\S5.2, Appendix E.8).
\end{itemize}
...
\begin{table}[H]
\centering\scriptsize\setlength{\tabcolsep}{3pt}
\caption{Coverage: attempted / carried / delivered episodes per work surface and policy (every tabletop cell; probes and demos excluded; 5185 episodes, 3705 carried, 2459 delivered).}
\label{tab:IVb}
\vspace{4pt}
