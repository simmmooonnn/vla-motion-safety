...
$\pi_{0.5}$ \textperiodcentered{} Franka & \textbf{50} (T1 100, T2 1) & \textbf{58} (T3 43, T4 73) & \textbf{7} (T5b 7) & \textbf{83} (T6 94, T6b 72) \\
...
scripted straight-line controls \textperiodcentered{} Franka & \textbf{51} (T1 100, T2 1) & \textbf{30} (T3 47, T4 13) & \textbf{6} (T5b 6) & --- (T6 100, T6b 0/1) \\
...
\begin{itemize}
  ...
  \item \textbf{Evidence (tabletop):} $\pi_{0.5}$'s mug leaves upright by more than 45$^{\circ}$ mid-transport on 266/362 carries and by more than a full cup's 14--27$^{\circ}$ spill angle on 1098/1310, the task still scored a success (\S5.2, Appendix E.8).
\end{itemize}
...
$\pi_{0.5}$ \textperiodcentered{} Franka & 56/56 = 100 \% [94, 100] & 3/477 = 1 \% [0, 2] & 32/75 = 43 \% [32, 54] & 266/362 = 73 \% [69, 78] & (539/539 exposure) & 6/83 = 7 \% [3, 15] & 78/83 = 94 \% [87, 97] & 58/80 = 72 \% [62, 81] \\
...
scripted straight-line controls \textperiodcentered{} Franka & 24/24 = 100 \% [86, 100] & 3/280 = 1 \% [0, 3] & 90/192 = 47 \% [40, 54] & 4/31 = 13 \% [5, 29] & (296/296 exposure) & 1/16 = 6 \% [1, 28] & 16/16 = 100 \% [81, 100] & 0/1 (below the floor) \\
\bottomrule
\end{tabular}
\end{table}
...
T4 above the 14--27$^{\circ}$ spill angle (27$^{\circ}$) & 0/17 & 320/362 = 88 \% [85, 91] & 50/64 = 78 \% [67, 86] & 23/27 = 85 \% [68, 94] & 18/31 = 58 \% [41, 74] \\
...
\begin{table}[H]
\centering\scriptsize\setlength{\tabcolsep}{3pt}
\caption{Coverage: attempted / carried / delivered episodes per work surface and policy (every tabletop cell; probes and demos excluded; 4765 episodes, 3340 carried, 2232 delivered).}
\label{tab:IVb}
\vspace{4pt}
