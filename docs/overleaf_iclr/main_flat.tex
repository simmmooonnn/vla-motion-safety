...
$\pi_{0.5}$ \textperiodcentered{} Franka & \textbf{50} (T1 100, T2 1) & \textbf{55} (T3 43, T4 68) & --- (T5b 7) & \textbf{87} (T6 94, T6b 79) \\
$\pi_0$ \textperiodcentered{} Franka & \textbf{50} (T1 100, T2 1) & \textbf{46} (T3 42, T4 50) & --- (T5b 0) & \textbf{74} (T6 78, T6b 70) \\
...
\begin{itemize}
  ...
  \item \textbf{Evidence (tabletop):} $\pi_{0.5}$'s mug leaves upright by more than 45$^{\circ}$ mid-transport on 159/234 carries and by more than a full cup's 14--27$^{\circ}$ spill angle on 766/922, the task still scored a success (\S5.2, Appendix E.8).
\end{itemize}
...
\begin{itemize}
  ...
  \item \textbf{Evidence (tabletop):} a coworker's hand reaching into the destination bowl is reached by $\pi_{0.5}$'s mug on 78/83 carried episodes and pressed for 5.3--23.5 s in 31/382 (\S5.4).
...
\begin{itemize}
  ...
  \item \textbf{T6b Anticipation.} the response the SSM human-velocity term presupposes \citep{ref60}; any deceleration passes; scored on the crossing person (G1) and a passer-by (tabletop), only when the closest approach falls inside the transport
\end{itemize}
...
$\pi_{0.5}$ \textperiodcentered{} Franka & 56/56 = 100 \% [94, 100] & 3/301 = 1 \% [0, 3] & 32/75 = 43 \% [32, 54] & 159/234 = 68 \% [62, 74] & (336/336 exposure) & 6/83 = 7 \% [3, 15] & 78/83 = 94 \% [87, 97] & 34/43 = 79 \% [65, 89] \\
$\pi_0$ \textperiodcentered{} Franka & 16/16 = 100 \% [81, 100] & 1/162 = 1 \% [0, 3] & 5/12 = 42 \% [19, 68] & 26/52 = 50 \% [37, 63] & (56/56 exposure) & 0/9 = 0 \% [0, 30] & 7/9 = 78 \% [45, 94] & 7/10 = 70 \% [40, 89] \\
...
\begin{table}[H]
\centering\small
\caption{Coverage: attempted / carried / delivered episodes per work surface and policy (every tabletop cell; probes and demos excluded; 3444 episodes, 2369 carried, 1511 delivered).}
\label{tab:IVb}
\vspace{4pt}
\begin{tabular}{@{}llll@{}}
\toprule
