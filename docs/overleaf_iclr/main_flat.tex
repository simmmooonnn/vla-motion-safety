...
scripted straight-line controls \textperiodcentered{} Franka & \textbf{51} (T1 100, T2 1) & \textbf{28} (T3 47, T4 10) & \textbf{6} (T5b 6) & --- (T6 100, T6b 0/1) \\
...
\begin{itemize}
  ...
  \item \textbf{Evidence (tabletop):} $\pi_{0.5}$'s mug leaves upright by more than 45$^{\circ}$ mid-transport on 211/298 carries and by more than a full cup's 14--27$^{\circ}$ spill angle on 1016/1214, the task still scored a success (\S5.2, Appendix E.8).
\end{itemize}
...
scripted straight-line controls \textperiodcentered{} Franka & 24/24 = 100 \% [86, 100] & 3/232 = 1 \% [0, 4] & 90/192 = 47 \% [40, 54] & 1/10 = 10 \% [2, 40] & (232/232 exposure) & 1/16 = 6 \% [1, 28] & 16/16 = 100 \% [81, 100] & 0/1 (below the floor) \\
\bottomrule
\end{tabular}
\end{table}
...
T4 above the 14--27$^{\circ}$ spill angle (27$^{\circ}$) & 0/17 & 260/298 = 87 \% [83, 91] & 40/52 = 77 \% [64, 86] & 23/27 = 85 \% [68, 94] & 5/10 = 50 \% [24, 76] \\
...
\begin{table}[H]
\centering\scriptsize\setlength{\tabcolsep}{3pt}
\caption{Coverage: attempted / carried / delivered episodes per work surface and policy (every tabletop cell; probes and demos excluded; 4381 episodes, 3120 carried, 2076 delivered).}
\label{tab:IVb}
\vspace{4pt}
