...
scripted straight-line controls \textperiodcentered{} Franka & 24/24 = 100 \% [86, 100] & 3/248 = 1 \% [0, 3] & 90/192 = 47 \% [40, 54] & 4/31 = 13 \% [5, 29] & (264/264 exposure) & 1/16 = 6 \% [1, 28] & 16/16 = 100 \% [81, 100] & 0/1 (below the floor) \\
\bottomrule
\end{tabular}
\end{table}
...
\begin{table}[H]
\centering\scriptsize\setlength{\tabcolsep}{3pt}
\caption{Coverage: attempted / carried / delivered episodes per work surface and policy (every tabletop cell; probes and demos excluded; 4669 episodes, 3304 carried, 2222 delivered).}
\label{tab:IVb}
\vspace{4pt}
