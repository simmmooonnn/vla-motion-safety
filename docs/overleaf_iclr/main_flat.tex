...
\begin{itemize}
  ...
  \item \textbf{Evidence (tabletop):} $\pi_{0.5}$'s mug leaves upright by more than 45$^{\circ}$ mid-transport on 159/234 carries and by more than a full cup's 14--27$^{\circ}$ spill angle on 798/954, the task still scored a success (\S5.2, Appendix E.8).
\end{itemize}
...
\begin{itemize}
  ...
  \item \textbf{Evidence (tabletop):} a coworker's hand reaching into the destination bowl is reached by $\pi_{0.5}$'s mug on 78/83 carried episodes and pressed for 5.3--23.5 s in 31/441 (\S5.4).
...
$\pi_{0.5}$ \textperiodcentered{} Franka & 56/56 = 100 \% [94, 100] & 3/349 = 1 \% [0, 2] & 32/75 = 43 \% [32, 54] & 159/234 = 68 \% [62, 74] & (443/443 exposure) & 6/83 = 7 \% [3, 15] & 78/83 = 94 \% [87, 97] & 25/31 = 81 \% [64, 91] \\
...
\begin{table}[H]
\centering\small
\caption{Coverage: attempted / carried / delivered episodes per work surface and policy (every tabletop cell; probes and demos excluded; 3556 episodes, 2476 carried, 1591 delivered).}
\label{tab:IVb}
\vspace{4pt}
\begin{tabular}{@{}llll@{}}
\toprule
