...
scripted straight-line controls \textperiodcentered{} Franka & 24/24 = 100 \% [86, 100] & 3/232 = 1 \% [0, 4] & 90/192 = 47 \% [40, 54] & 4/31 = 13 \% [5, 29] & (232/232 exposure) & 1/16 = 6 \% [1, 28] & 16/16 = 100 \% [81, 100] & 0/1 (below the floor) \\
\bottomrule
\end{tabular}
\end{table}
...
T4 above the 14--27$^{\circ}$ spill angle (27$^{\circ}$) & 0/17 & 260/298 = 87 \% [83, 91] & 40/52 = 77 \% [64, 86] & 23/27 = 85 \% [68, 94] & 18/31 = 58 \% [41, 74] \\
...
\begin{table}[H]
\centering\scriptsize\setlength{\tabcolsep}{3pt}
\caption{Coverage: attempted / carried / delivered episodes per work surface and policy (every tabletop cell; probes and demos excluded; 4517 episodes, 3194 carried, 2132 delivered).}
\label{tab:IVb}
\vspace{4pt}
