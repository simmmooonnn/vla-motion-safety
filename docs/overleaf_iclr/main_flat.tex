...
$\pi_{0.5}$ \textperiodcentered{} Franka & \textbf{38} (T1 76, T2 1) & \textbf{59} (T3 43, T4 75) & \textbf{7} (T5b 7) & \textbf{83} (T6 94, T6b 72) \\
$\pi_0$ \textperiodcentered{} Franka & \textbf{50} (T1 100, T2 0) & \textbf{47} (T3 42, T4 52) & \textbf{0} (T5b 0) & \textbf{89} (T6 78, T6b 100) \\
GR00T N1.6-DROID \textperiodcentered{} Franka & --- (T1 2/2, T2 7) & \textbf{51} (T3 20, T4 82) & \textbf{0} (T5b 0) & --- (T6 56) \\
scripted straight-line controls \textperiodcentered{} Franka & \textbf{35} (T1 69, T2 1) & \textbf{30} (T3 47, T4 13) & \textbf{6} (T5b 6) & --- (T6 100, T6b 0/1) \\
...
\begin{itemize}
  ...
  \item \textbf{Evidence (tabletop):} $\pi_{0.5}$'s mug leaves upright by more than 45$^{\circ}$ mid-transport on 342/456 carries and by more than a full cup's 14--27$^{\circ}$ spill angle on 1275/1503, the task still scored a success (\S5.2, Appendix E.8).
\end{itemize}
...
$\pi_{0.5}$ \textperiodcentered{} Franka & 67/88 = 76 \% [66, 84] & 3/541 = 1 \% [0, 2] & 32/75 = 43 \% [32, 54] & 342/456 = 75 \% [71, 79] & (633/633 exposure) & 6/83 = 7 \% [3, 15] & 78/83 = 94 \% [87, 97] & 71/99 = 72 \% [62, 80] \\
...
GR00T N1.6-DROID \textperiodcentered{} Franka & 2/2 (below the floor) & 8/116 = 7 \% [4, 13] & 2/10 = 20 \% [6, 51] & 31/38 = 82 \% [67, 91] & (46/46 exposure) & 0/9 = 0 \% [0, 30] & 5/9 = 56 \% [27, 81] & --- \\
scripted straight-line controls \textperiodcentered{} Franka & 72/104 = 69 \% [60, 77] & 3/376 = 1 \% [0, 2] & 90/192 = 47 \% [40, 54] & 4/31 = 13 \% [5, 29] & (440/440 exposure) & 1/16 = 6 \% [1, 28] & 16/16 = 100 \% [81, 100] & 0/1 (below the floor) \\
\bottomrule
\end{tabular}
\end{table}
...
T4 above the 14--27$^{\circ}$ spill angle (27$^{\circ}$) & 0/17 & 414/456 = 91 \% [88, 93] & 65/81 = 80 \% [70, 87] & 33/38 = 87 \% [73, 94] & 18/31 = 58 \% [41, 74] \\
...
\begin{table}[H]
\centering\scriptsize\setlength{\tabcolsep}{3pt}
\caption{Coverage: attempted / carried / delivered episodes per work surface and policy (every tabletop cell; probes and demos excluded; 5337 episodes, 3842 carried, 2552 delivered).}
\label{tab:IVb}
\vspace{4pt}
...
\textbf{T4.} $\pi_{0.5}$ carries a mug tilted in its grasp: over 456 carries in 59 canonical cells at six surfaces its axis leaves upright by more than 45$^{\circ}$ mid-transport on 342 (75 \%) and by more than 27$^{\circ}$ on 414; 329 of the 342 are delivered to the bowl and scored successful (the task battery's tilt rates are in Table~\ref{tab:IV}). Told to keep hot coffee upright, it still tilts the mug past 45$^{\circ}$ on 16/24 (27$^{\circ}$: 21/24): the command does not change the carry, nor at the kitchen counter (21/24 past 45$^{\circ}$), the office desk (22/24), the packing station (11/13) or the drawer kitchen (14/14). Where the tilt happens matters for a scald: over every $\pi_{0.5}$ mug carry with a person present, the peak tilt exceeds 45$^{\circ}$ within 0.60 m of them on 728/1782 and farther away on 482/1782; the payload leaves the work surface (a drop) on 30/2692 episodes. A pitcher (a taller, heavier liquid vessel) and a cordless drill, a third hazardous object (bit forward), are never lifted by $\pi_{0.5}$ (0/16 and 0/32 attempts): both are capability boundaries, not safety rates. $\pi_0$ tilts less where it carries (62/126 above 45$^{\circ}$).

\textbf{T5a.} Every transport with the person at the table passes inside the 0.94 m stop distance (633/633; exposure, not scored --- the arm never leaves it), and the near-band payload speed is 0.109 vs 0.113 m/s, Welch \emph{p} = 0.79, \emph{n} = 26 vs 13 with the person visible or the position empty: no speed-and-separation behavior.
...
\textbf{A third DROID policy.} GR00T N1.6-DROID, the same model family as the G1 policy, runs in this family but slowly: with 90 s episodes it carries on 61/178 episodes. Where it carries, the mug leaves upright by more than 45$^{\circ}$ on 38/48 (11--169$^{\circ}$); its links come within 0.10 m of the person on 10/123 episodes; transports with the person at the table pass inside the stop distance on 46/46; the scissors' tip points into the person's half-space on 2/10; the reaching hand is reached on 5/10 carried episodes.
