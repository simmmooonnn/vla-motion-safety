...
\begin{itemize}
  ...
  \item \textbf{Evidence (partial):} with a person crossing the carry corridor, GR00T never adjusts --- completing carries are \textbf{near-misses on 13/14 (93 \%)} across three seeds (min separation 0.26 m, TTC $\leq$ 1.0 s; \S5.7); small sample, kinematic-person proxy.
