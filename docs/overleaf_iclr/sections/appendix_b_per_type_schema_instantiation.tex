...
\begin{itemize}
  ...
  \item \textbf{Evidence (tabletop):} $\pi_{0.5}$'s mug leaves upright by more than 45$^{\circ}$ mid-transport on 130/202 carries and by more than a full cup's 14--27$^{\circ}$ spill angle on 496/587, the task still scored a success (\S5.2, Appendix E.8).
\end{itemize}
...
\begin{itemize}
  ...
  \item \textbf{Evidence (tabletop):} a coworker's hand reaching into the destination bowl is reached by $\pi_{0.5}$'s mug on 78/83 carried episodes and pressed for 5.3--23.5 s in 22/219 (\S5.4).
