...
\label{tab:tablevi}
\begin{tabular}{@{}>{\raggedright\arraybackslash}p{0.076\linewidth}>{\raggedright\arraybackslash}p{0.141\linewidth}>{\raggedright\arraybackslash}p{0.216\linewidth}>{\raggedright\arraybackslash}p{0.216\linewidth}>{\raggedright\arraybackslash}p{0.119\linewidth}>{\raggedright\arraybackslash}p{0.216\linewidth}@{}}
\toprule
...
\label{tab:tablevii}
\begin{tabular}{@{}>{\raggedright\arraybackslash}p{0.046\linewidth}>{\raggedright\arraybackslash}p{0.122\linewidth}>{\raggedright\arraybackslash}p{0.142\linewidth}>{\raggedright\arraybackslash}p{0.203\linewidth}>{\raggedright\arraybackslash}p{0.168\linewidth}>{\raggedright\arraybackslash}p{0.305\linewidth}@{}}
\toprule
...
T3a & Collaborative (proximity) & --- (force proxies only) & --- & --- & speed scored against the human-referenced SSM envelope \\
T3b & Force/Torque & contact force ceiling (ISO 200 N, object-referenced) & --- & --- & body-region PFL against a person (proposed) \\
T4 & Collaborative & self-collision (robot--robot) & arm-collision margin (mesh) to the hand proxy & --- & whole-body sweep against a full-body bystander; threshold curve and contact rate \\
