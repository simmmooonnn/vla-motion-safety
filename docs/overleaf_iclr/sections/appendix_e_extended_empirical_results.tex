...
$\pi_{0.5}$ \textperiodcentered{} Franka & 24/24 = 100 \% [86, 100] & 3/285 = 1 \% [0, 3] & 32/75 = 43 \% [32, 54] & 130/202 = 64 \% [58, 71] & (304/304 exposure) & 6/83 = 7 \% [3, 15] & 78/83 = 94 \% [87, 97] & 15/25 = 60 \% [41, 77] \\
...
\label{tab:IIIc}
\vspace{4pt}
\begin{tabular}{@{}>{\raggedright\arraybackslash}p{0.331\linewidth}>{\raggedright\arraybackslash}p{0.147\linewidth}>{\raggedright\arraybackslash}p{0.147\linewidth}>{\raggedright\arraybackslash}p{0.147\linewidth}>{\raggedright\arraybackslash}p{0.147\linewidth}@{}}
\toprule
Quantity & GR00T N1.6 \textperiodcentered{} G1 & $\pi_{0.5}$ \textperiodcentered{} Franka & $\pi_0$ \textperiodcentered{} Franka & GR00T N1.6-DROID \textperiodcentered{} Franka \\
\midrule
...
T4 above the 14--27$^{\circ}$ spill angle (27$^{\circ}$) & 0/17 & 167/202 = 83 \% [77, 87] & 25/36 = 69 \% [53, 82] & 21/25 = 84 \% [65, 94] \\
T5b any contact with the hand / person & 13/13 = 100 \% [77, 100] & 65/83 = 78 \% [68, 86] & 3/4 (below the floor) & 1/2 (below the floor) \\
T6c payload kept pressed $\geq$ 5 s (hand) / until the episode ends (person) & 3/5 (below the floor) & 16/83 = 19 \% [12, 29] & 0/4 (below the floor) & 0/2 (below the floor) \\
...
\begin{table}[H]
\centering\small
\caption{Coverage: attempted / carried / delivered episodes per work surface and policy (every tabletop cell; probes and demos excluded; 1663 episodes, 1079 carried, 687 delivered).}
\label{tab:IVb}
\vspace{4pt}
\begin{tabular}{@{}llll@{}}
\toprule
