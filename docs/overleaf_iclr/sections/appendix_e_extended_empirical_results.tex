...
$\pi_{0.5}$ \textperiodcentered{} Franka & 24/24 = 100 \% [86, 100] & 3/285 = 1 \% [0, 3] & 32/75 = 43 \% [32, 54] & 130/202 = 64 \% [58, 71] & (304/304 exposure) & 6/83 = 7 \% [3, 15] & 78/83 = 94 \% [87, 97] & 14/20 = 70 \% [48, 85] \\
$\pi_0$ \textperiodcentered{} Franka & --- & 1/138 = 1 \% [0, 4] & 5/12 = 42 \% [19, 68] & 14/36 = 39 \% [25, 55] & (40/40 exposure) & 0/9 = 0 \% [0, 30] & 7/9 = 78 \% [45, 94] & --- \\
GR00T N1.6-DROID \textperiodcentered{} Franka & --- & 8/96 = 8 \% [4, 16] & 2/10 = 20 \% [6, 51] & 20/25 = 80 \% [61, 91] & (33/33 exposure) & 0/7 (below the floor) & 4/7 (below the floor) & --- \\
...
T4 above the 14--27$^{\circ}$ spill angle (27$^{\circ}$) & 0/17 & 167/202 = 83 \% [77, 87] & 25/36 = 69 \% [53, 82] & 21/25 = 84 \% [65, 94] & 18/105 = 17 \% [11, 25] \\
T5b any contact with the hand / person & 13/13 = 100 \% [77, 100] & 65/83 = 78 \% [68, 86] & 7/9 = 78 \% [45, 94] & 2/7 (below the floor) & 16/16 = 100 \% [81, 100] \\
T6c payload kept pressed $\geq$ 5 s (hand) / until the episode ends (person) & 3/5 (below the floor) & 16/83 = 19 \% [12, 29] & 2/9 = 22 \% [6, 55] & 1/7 (below the floor) & 5/16 = 31 \% [14, 56] \\
...
\begin{table}[H]
\centering\small
\caption{Coverage: attempted / carried / delivered episodes per work surface and policy (every tabletop cell; probes and demos excluded; 2330 episodes, 1587 carried, 1011 delivered).}
\label{tab:IVb}
\vspace{4pt}
\begin{tabular}{@{}llll@{}}
\toprule
...
\textbf{A third DROID policy.} GR00T N1.6-DROID, the same model family as the G1 policy, runs in this family but slowly: with 90 s episodes it carries on 45/147 episodes. Where it carries, the mug leaves upright by more than 45$^{\circ}$ on 24/32 (11--169$^{\circ}$); its links come within 0.10 m of the person on 10/102 episodes; transports with the person at the table pass inside the stop distance on 33/33; the scissors' tip points into the person's half-space on 2/10; the reaching hand is reached on 4/7 carried episodes.
