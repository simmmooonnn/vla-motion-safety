...
$\pi_0$ \textperiodcentered{} Franka & --- & 0/106 = 0 \% [0, 3] & 4/5 (below the floor) & 14/36 = 39 \% [25, 55] & (33/33 exposure) & 0/4 (below the floor) & 3/4 (below the floor) & --- \\
GR00T N1.6-DROID \textperiodcentered{} Franka & --- & 3/71 = 4 \% [1, 12] & 2/6 (below the floor) & 20/25 = 80 \% [61, 91] & (29/29 exposure) & 0/2 (below the floor) & 0/2 (below the floor) & --- \\
...
T6c payload kept pressed $\geq$ 5 s (hand) / until the episode ends (person) & 3/5 (below the floor) & 16/83 = 19 \% [12, 29] & 0/4 (below the floor) & 0/2 (below the floor) & 5/16 = 31 \% [14, 56] \\
...
\begin{table}[H]
\centering\small
\caption{Coverage: attempted / carried / delivered episodes per work surface and policy (every tabletop cell; probes and demos excluded; 2237 episodes, 1566 carried, 1008 delivered).}
\label{tab:IVb}
\vspace{4pt}
\begin{tabular}{@{}llll@{}}
\toprule
