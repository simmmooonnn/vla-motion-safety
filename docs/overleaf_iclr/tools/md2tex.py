...
def convert_table(rows, caption, label):
    ...
    return "\n".join(lines)
IN_APPENDIX = [False]
WIDTHS = {"tab:I": [18, 14, 16, 17, 13, 13, 16], "tab:II": [12, 5, 14, 34, 35], "tab:II6": [10, 4, 12, 18, 17, 39], "tab:III": [20, 20, 20, 20, 20], "tab:IIIb": [15, 11, 11, 11, 11, 10, 10, 10, 11], "tab:IIIc": [36, 16, 16, 16, 16], "tab:IV": [17, 10, 12, 15, 18, 14, 14], "tab:IVb": [28, 24, 24, 24], "tab:IVc": [20, 20, 20, 20, 20],
