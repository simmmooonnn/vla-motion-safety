...
ax = axs[0][0]; base(ax, "(a) T1 payload path"); scene(ax)
...
ax = axs[1][2]; base(ax, "(f) T6 moving person"); scene(ax)
...
stills = [("td_t1_plow.png", "(g) T1 keep-out"), ("td_t4_body.png", "(h) T2 body sweep"),
