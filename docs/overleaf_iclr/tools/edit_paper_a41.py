...
exec(open(pathlib.Path(__file__).with_name("edit_paper_a92_c5.py"), encoding="utf-8").read())
exec(open(pathlib.Path(__file__).with_name("edit_paper_a93_trim21.py"), encoding="utf-8").read())
exec(open(pathlib.Path(__file__).with_name("edit_paper_a94_trim22.py"), encoding="utf-8").read())
exec(open(pathlib.Path(__file__).with_name("edit_paper_a95_trim23.py"), encoding="utf-8").read())
exec(open(pathlib.Path(__file__).with_name("edit_paper_a96_ik7.py"), encoding="utf-8").read())
exec(open(pathlib.Path(__file__).with_name("edit_paper_a97_factorial.py"), encoding="utf-8").read())
exec(open(pathlib.Path(__file__).with_name("edit_paper_a98_seeds.py"), encoding="utf-8").read())
exec(open(pathlib.Path(__file__).with_name("edit_paper_a99_t1cross.py"), encoding="utf-8").read())
exec(open(pathlib.Path(__file__).with_name("edit_paper_a100_ctrl20_pi0appear.py"), encoding="utf-8").read())
exec(open(pathlib.Path(__file__).with_name("edit_paper_a101_grid.py"), encoding="utf-8").read())
exec(open(pathlib.Path(__file__).with_name("edit_paper_a102_grid_read.py"), encoding="utf-8").read())
exec(open(pathlib.Path(__file__).with_name("edit_paper_a103_pi0_20.py"), encoding="utf-8").read())
exec(open(pathlib.Path(__file__).with_name("edit_paper_a104_queueA.py"), encoding="utf-8").read())
exec(open(pathlib.Path(__file__).with_name("edit_paper_a105_b5seeds.py"), encoding="utf-8").read())
exec(open(pathlib.Path(__file__).with_name("edit_paper_a106_twohaz.py"), encoding="utf-8").read())
exec(open(pathlib.Path(__file__).with_name("edit_paper_a107_drift.py"), encoding="utf-8").read())
exec(open(pathlib.Path(__file__).with_name("edit_paper_a108_ii.py"), encoding="utf-8").read())
exec(open(pathlib.Path(__file__).with_name("edit_paper_a109_trim24.py"), encoding="utf-8").read())
exec(open(pathlib.Path(__file__).with_name("edit_paper_a110_gr00t_off.py"), encoding="utf-8").read())
exec(open(pathlib.Path(__file__).with_name("edit_paper_a111_drift_annexA.py"), encoding="utf-8").read())
exec(open(pathlib.Path(__file__).with_name("edit_paper_a112_trim25.py"), encoding="utf-8").read())
exec(open(pathlib.Path(__file__).with_name("edit_paper_a113_pi0_gr00t.py"), encoding="utf-8").read())
