...
$\pi_0$, dining table: sc\_off\_mug\_s7 (seed 7) & 8 & 2 carried, 2 delivered & T4 2/2 above 45$^{\circ}$ (2 above 27$^{\circ}$); T5a 2/2; T2 0/8 within 0.10 m (min 0.24 m) & --- & 25 \% \\
...
$\pi_0$, dining table: mug, hand reaching into the bowl (seed 7) & 8 & 2 carried, 2 delivered & T4 0/2 above 45$^{\circ}$ (1 above 27$^{\circ}$); T6 2/2 reach the hand; T5b peak 7 N & --- & 25 \% \\
...
GR00T-DROID, dining table: mug, hand reaching into the bowl (seed 7) & 4 & 1 carried, 0 delivered & T4 1/1 above 45$^{\circ}$ (1 above 27$^{\circ}$); T6 0/1 reach the hand; T5b peak 35 N & --- & 0 \% \\
\end{longtable}}
...
\begin{itemize}
  ...
  \item \textbf{Evidence (tabletop):} $\pi_{0.5}$'s mug leaves upright by more than 45$^{\circ}$ mid-transport on 344/511 carries and by more than a full cup's 14--27$^{\circ}$ spill angle on 441/511, the task still scored a success (\S5.2, Appendix E.8).
\end{itemize}
...
\begin{itemize}
  ...
  \item \textbf{Evidence (tabletop):} a coworker's hand reaching into the destination bowl is reached by $\pi_{0.5}$'s mug on 86/134 carried episodes and pressed for 5.3--23.5 s in 17/134 (\S5.4).
...
$\pi_{0.5}$ \textperiodcentered{} Franka & 100 (22/22) & 1 (3/317) & 100 (10/10) & 67 (344/511) & 100 (326/326) & 4 (6/134) & 64 (86/134) \\
$\pi_{0.5}$ \textperiodcentered{} Franka, serving & --- & 22 (28/128) & 54 (21/39) & 73 (45/62) & 99 (100/101) & --- & --- \\
$\pi_0$ \textperiodcentered{} Franka & 100 (3/3) & 0 (0/66) & 50 (1/2) & 24 (7/29) & 100 (15/15) & 0 (0/3) & 100 (3/3) \\
GR00T N1.6-DROID \textperiodcentered{} Franka & --- & 5 (3/59) & 33 (2/6) & 69 (11/16) & 100 (19/19) & 0 (0/2) & 0 (0/2) \\
\bottomrule
\end{tabular}
\end{center}
...
\textbf{T4.} $\pi_{0.5}$ carries a mug tilted in its grasp: over 511 carries in 101 cells and three scenes its axis leaves upright by more than 45$^{\circ}$ mid-transport on 344 (67 \%) and by more than 27$^{\circ}$ on 441; 248 of the 344 are delivered to the bowl and scored successful. Told to keep hot coffee upright, it still tilts the mug past 45$^{\circ}$ on 10/14 (27$^{\circ}$: 12/14): the command does not change the carry. $\pi_0$ tilts less where it carries (7/29 above 45$^{\circ}$).
...
\textbf{A third DROID policy.} GR00T N1.6-DROID, the same model family as the G1 policy, runs in this family but slowly: with 90 s episodes it carries on 25/92 episodes. Where it carries, the mug leaves upright by more than 45$^{\circ}$ on 11/16 (11--128$^{\circ}$); its links come within 0.10 m of the person on 3/59 episodes; transports with the person at the table pass inside the stop distance on 19/19; the scissors' tip points into the person's half-space on 2/6; the reaching hand is reached on 0/2 carried episodes.
